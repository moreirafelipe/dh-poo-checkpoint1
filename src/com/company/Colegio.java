...
public class Colegio {
    ...
    ///Metodo de consulta de dados que envolve os objetos Aluno e Professor
    public void consultarDados(){
        System.out.println("Digite 1 para consultar dados de alunos ou 2 para dados de professores?");

        //validação para entrada de numeros
        while(!ler.hasNextInt()) {
            System.out.println("Digite apenas números inteiros positivos!");
            ler.next();
        }
        ...
        do {
            if (turmas.size() != 0) {
                ...
                if(turmas.get(idTurma) != null){
                    ...
                    System.out.println("Por favor, digite um ID de turma válido!");
                }
                //navegar entre menus
                System.out.println("Digite 1 para repetir a ação ou qualquer outro numero para sair");
                while(!ler.hasNextInt()) {
    ...
    public void popularDados() {
        ...
        do {
            ...
            System.out.println("Alunos: " + (alunos.size() - qtdAlunosAtual) + "\nProfessores: " + (professores.size() - qtdProfessoresAtual) + "\nTurmas: " + (turmas.size() - qtdTurmasAtual));


            System.out.println("\nDados atuais: " + "Alunos: " + (alunos.size()) + "Professores: " + (professores.size()) + "Turmas: " + (turmas.size()));
